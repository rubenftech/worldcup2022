...
class AVL{
    ...
    void array_to_AVL_inorder(S *array,int numOfNodes){
        int i=0;
        array_to_AVL_inorder_helper(array, i,numOfNodes);
    }

    void array_to_AVL_inorder_helper(S *arrKey,int start, int end){
//        if(i==0){
//            return;
//        }
